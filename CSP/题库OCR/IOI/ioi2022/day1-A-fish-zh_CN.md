...
![Logo of the 34th International Olympiad in Informatics (IOI) 2022 Indonesia, featuring a stylized sun or flower with binary code patterns.](2dfa6ac3edfe874f68aa0cbccaa42322_img.jpg)

Logo of the 34th International Olympiad in Informatics (IOI) 2022 Indonesia, featuring a stylized sun or flower with binary code patterns.
...
- 单元  $(X[i] - 1, Y[i])$  或  $(X[i] + 1, Y[i])$  中至少有一个被某个长堤盖住，而且
- 没有长堤盖住单元  $(X[i], Y[i])$ 。
...
1. (3 分)  $X[i]$  是偶数 (对于所有满足  $0 \leq i \leq M - 1$  的  $i$ )
2. (6 分)  $X[i] \leq 1$  (对于所有满足  $0 \leq i \leq M - 1$  的  $i$ )
3. (9 分)  $Y[i] = 0$  (对于所有满足  $0 \leq i \leq M - 1$  的  $i$ )
4. (14 分)  $N \leq 300$ ,  $Y[i] \leq 8$  (对于所有满足  $0 \leq i \leq M - 1$  的  $i$ )
5. (21 分)  $N \leq 300$
6. (17 分)  $N \leq 3000$
