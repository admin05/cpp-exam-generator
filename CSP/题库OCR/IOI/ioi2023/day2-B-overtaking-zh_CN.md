...
- 巴士 0、巴士 1 和 巴士 3 早于 巴士 2 到达调度站 0，所以  $t_{2,1} = \max([e_{0,1}, e_{1,1}, e_{2,1}, e_{3,1}]) = 60$ 。
...
![Graph titled 'arrival_time(0)' showing five linear paths on a grid. The x-axis ranges from 0 to 6, and the y-axis from 0 to 180. Path 0 (green) starts at (0, 20) and ends at (6, 50). Path 1 (grey) starts at (0, 10) and ends at (6, 130). Path 2 (orange) starts at (0, 40) and ends at (6, 180). Path 3 (blue) starts at (0, 0) and ends at (6, 180). Path 4 (black dotted) starts at (0, 0) and ends at (6, 60). Vertical dashed lines are at x=1, 3, and 6. Graph titled 'arrival_time(50)' showing the same five paths as the first graph, but with path 4 (black dotted) modified. Path 4 now follows the blue path (Path 3) from x=0 to x=3, then branches off to end at (6, 130). The other paths remain the same.](5d92d5c9cc01a262b0389d138caa9aea_img.jpg)

| arrival_time(0) | arrival_time(50) |
|-----------------|------------------|
|                 |                  |

Graph titled 'arrival\_time(0)' showing five linear paths on a grid. The x-axis ranges from 0 to 6, and the y-axis from 0 to 180. Path 0 (green) starts at (0, 20) and ends at (6, 50). Path 1 (grey) starts at (0, 10) and ends at (6, 130). Path 2 (orange) starts at (0, 40) and ends at (6, 180). Path 3 (blue) starts at (0, 0) and ends at (6, 180). Path 4 (black dotted) starts at (0, 0) and ends at (6, 60). Vertical dashed lines are at x=1, 3, and 6. Graph titled 'arrival\_time(50)' showing the same five paths as the first graph, but with path 4 (black dotted) modified. Path 4 now follows the blue path (Path 3) from x=0 to x=3, then branches off to end at (6, 130). The other paths remain the same.
