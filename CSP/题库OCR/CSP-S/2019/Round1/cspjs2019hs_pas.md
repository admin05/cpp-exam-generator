...
![A triangular diagram representing a path in a grid. The top node is a_{1,1}. It branches to a_{2,1} and a_{2,2}. a_{2,1} branches to a_{3,1} and a_{3,2}. a_{2,2} branches to a_{3,2} and a_{3,3}. Below this, there are ellipses and a row of nodes a_{n,1}, a_{n,2}, ..., a_{n,n}.](b230b8f21d8e82d55c0d311c8c32ef73_img.jpg)

A triangular diagram representing a path in a grid. The top node is a\_{1,1}. It branches to a\_{2,1} and a\_{2,2}. a\_{2,1} branches to a\_{3,1} and a\_{3,2}. a\_{2,2} branches to a\_{3,2} and a\_{3,3}. Below this, there are ellipses and a row of nodes a\_{n,1}, a\_{n,2}, ..., a\_{n,n}.
...
5    unlock, threshold, bonus, cnt : array[0..maxn-1] of longint;
