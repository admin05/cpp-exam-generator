...
![A directed graph with 10 nodes (A-J) and weighted edges. The graph is structured in layers: A is the source; B, C, D are the next layer; E, F, G are the third; H, I are the fourth; and J is the target. Edges and weights: A to B (2), A to C (5), A to D (1); B to E (12), B to F (10), B to G (14); C to E (6), C to F (10), C to G (4); D to E (13), D to F (12), D to G (11); E to H (3), E to I (9); F to H (6), F to I (5); G to H (8), G to I (10); H to J (5), I to J (2).](12a6537c92844d5b393104c02e8dfc2f_img.jpg)
