...
A. 162.105.117.27      B. 192.168.0.1      C. 256.256.129.1      D. 10.0.0.1
...
![Diagram of a linked list with three nodes. Each node is a rectangle divided into two parts: 'data' on the left and 'next' on the right. Arrows labeled 'p', 'q', and 'r' point to the first node, the second node, and the third node respectively. The 'next' field of the first node points to the second node, the second node points to the third node, and the third node points to a null terminator (a small square with a diagonal line).](715219db84ec2a5622d09f9d822b4550_img.jpg)
...
- 若逻辑变量 A、C 为真，B、D 为假，以下逻辑运算表达式为真的有（    ）。
 

A.  $(B \vee C \vee D) \vee D \wedge A$                       B.  $((\neg A \wedge B) \vee C) \wedge \neg B$

C.  $(A \wedge B) \vee (C \wedge D \vee \neg A)$                       D.  $A \wedge (D \vee \neg C) \wedge B$
- 下列（    ）软件属于操作系统软件。
...
![A weighted undirected graph with 9 nodes (A, B, C, D, E, F, G, H, I) and 15 edges. The edges and their weights are: A-B (3), A-F (6), A-G (4), B-C (1), B-H (7), C-F (1), C-D (8), C-H (9), D-E (5), D-I (3), E-I (4), F-H (2), G-H (4), G-I (4), H-I (4).](d3ca266c298aeb34b019960c6c36f187_img.jpg)
...
A weighted undirected graph with 9 nodes (A, B, C, D, E, F, G, H, I) and 15 edges. The edges and their weights are: A-B (3), A-F (6), A-G (4), B-C (1), B-H (7), C-F (1), C-D (8), C-H (9), D-E (5), D-I (3), E-I (4), F-H (2), G-H (4), G-I (4), H-I (4).
