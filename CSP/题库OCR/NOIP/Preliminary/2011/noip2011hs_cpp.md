...
![A binary tree diagram. Node A is the root. Node B is the left child of A, and Node C is the right child of A. Node D is the left child of B, and Node E is the right child of B. Node F is the left child of E.](17b9d89b91e10c3efc38193baedee268_img.jpg)

```
graph TD; A((A)) --- B((B)); A --- C((C)); B --- D((D)); B --- E((E)); E --- F((F));
```

A binary tree diagram. Node A is the root. Node B is the left child of A, and Node C is the right child of A. Node D is the left child of B, and Node E is the right child of B. Node F is the left child of E.
...
![A Cartesian tree diagram for the sequence 7, 2, 12, 1, 10, 5, 15, 3. The root node is 1. Its left child is 2, and its right child is 3. Node 2 has left child 7 and right child 12. Node 3 has left child 5, and node 5 has left child 10 and right child 15.](042733dc5e8e7f5f30b60adba3266cde_img.jpg)
...
A Cartesian tree diagram for the sequence 7, 2, 12, 1, 10, 5, 15, 3. The root node is 1. Its left child is 2, and its right child is 3. Node 2 has left child 7 and right child 12. Node 3 has left child 5, and node 5 has left child 10 and right child 15.
