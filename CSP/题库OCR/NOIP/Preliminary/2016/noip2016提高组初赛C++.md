...
- 试题纸共有 13 页，答题纸共有 2 页，满分 100 分。请在答题纸上作答，写在试题纸上的一律无效。
...
![A binary tree diagram with 6 nodes. The root node has a left child and a right child. The left child has a left child and a right child. The right child has a left child and a right child. The left child of the root's right child has a right child. The right child of the root's right child has a right child. All other children are null.](c2ddad56c1553f2499aaf7ef8cef6777_img.jpg)

A binary tree diagram with 6 nodes. The root node has a left child and a right child. The left child has a left child and a right child. The right child has a left child and a right child. The left child of the root's right child has a right child. The right child of the root's right child has a right child. All other children are null.
...
![A social network graph with 12 nodes: Dana, Sam, Michael, Monica, John, Lucia, Alex, Eve, Peter, Jacob, Lena, and Charles. Edges represent friendships: Dana-Sam, Dana-Michael, Dana-Monica, Dana-Lucia, Michael-Monica, Michael-Lucia, Michael-Eve, Michael-Jacob, John-Eve, John-Lucia, Eve-Lucia, Eve-Jacob, Eve-Lena, Lucia-Jacob, Lucia-Peter, Lucia-Alex, Jacob-Peter, Jacob-Charles, Peter-Charles, Peter-Alex, and Alex-Monica.](895d588a848d9963890c938763de9ecf_img.jpg)
...
A social network graph with 12 nodes: Dana, Sam, Michael, Monica, John, Lucia, Alex, Eve, Peter, Jacob, Lena, and Charles. Edges represent friendships: Dana-Sam, Dana-Michael, Dana-Monica, Dana-Lucia, Michael-Monica, Michael-Lucia, Michael-Eve, Michael-Jacob, John-Eve, John-Lucia, Eve-Lucia, Eve-Jacob, Eve-Lena, Lucia-Jacob, Lucia-Peter, Lucia-Alex, Jacob-Peter, Jacob-Charles, Peter-Charles, Peter-Alex, and Alex-Monica.
...
![A schematic diagram of an orchard irrigation system. Water enters from the top left into a tank. A pipe with valve B leads down to a junction. From this junction, one pipe goes down through valve A to the ground, and another pipe goes right through valve C to a second tank. From the second tank, a pipe goes down through valve D to the ground. A third pipe branches off from the main line between valves B and C, goes down, and then turns right to lead to a tree. The tree is represented by a large circle on the right side of the diagram.](2fa4a1bf91d0f34e87c689fbc1211fe3_img.jpg)
...
之前进入教室的并且和他身高最相近的人。（第一空 2 分，其余 3 分）
...
- 2. (交通中断) 有一个小国家，国家内有  $n$  座城市和  $m$  条双向的道路，每条道路连接着两座不同的城市。其中 1 号城市为国家的首都。由于地震频繁可能导致某一个城市与外界交通全部中断。这个国家的首脑想知道，如果只有第  $i(i>1)$  个城市因地震而导致交通中断时，首都到多少个城市的最短路径长度会发生变化。如果因为无法通过第  $i$  个城市而导致从首都出发无法到达某个城
