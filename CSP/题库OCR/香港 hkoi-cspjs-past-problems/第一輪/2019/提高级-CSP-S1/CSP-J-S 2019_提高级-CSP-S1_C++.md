...
![Diagram of a number triangle. The top node is a_{1,1}. It branches to a_{2,1} and a_{2,2}. These branch to a_{3,1}, a_{3,2}, and a_{3,3}. Ellipses indicate further rows down to a_{n,1}, a_{n,2}, ..., a_{n,n}.](def9846a069a7f1d0ecf7f5eb3ec2d06_img.jpg)

```
graph TD; a11[a_{1,1}] --> a21[a_{2,1}]; a11 --> a22[a_{2,2}]; a21 --> a31[a_{3,1}]; a21 --> a32[a_{3,2}]; a22 --> a32; a22 --> a33[a_{3,3}]; a31 -.-> an1[a_{n,1}]; a32 -.-> an2[a_{n,2}]; a33 -.-> ann[a_{n,n}];
```

Diagram of a number triangle. The top node is a\_{1,1}. It branches to a\_{2,1} and a\_{2,2}. These branch to a\_{3,1}, a\_{3,2}, and a\_{3,3}. Ellipses indicate further rows down to a\_{n,1}, a\_{n,2}, ..., a\_{n,n}.
