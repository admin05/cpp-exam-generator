...
![An undirected graph with 5 vertices labeled a, b, c, d, and e. Vertex a is at the top, connected to b on the left and c on the right. Vertex b is connected to a and d below it. Vertex c is connected to a and d. Vertex d is connected to b and c. Vertex e is connected only to c. The graph consists of a diamond shape (a-b-d-c-a) with an additional edge from c to e.](9e6062272bbe3ddbb7c0606721d64cf0_img.jpg)

An undirected graph with 5 vertices labeled a, b, c, d, and e. Vertex a is at the top, connected to b on the left and c on the right. Vertex b is connected to a and d below it. Vertex c is connected to a and d. Vertex d is connected to b and c. Vertex e is connected only to c. The graph consists of a diamond shape (a-b-d-c-a) with an additional edge from c to e.
